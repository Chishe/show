...
export default function PlanTable() {
    ...
    return (
        <div className="w-full bg-[#100C2A] py-4">
            <div className="w-full overflow-x-auto max-h-[80vh] p-2 sm:p-4">
                <table className="min-w-[1000px] w-max table-auto border-collapse text-xs">
                    <thead>
                        ...
                        {rows.length === 0 ? (
                            ...
                            rows.map((row) => (
                                <React.Fragment key={row.seq}>
                                    <tr>
                                        <td
                                            className="p-2 border sticky left-0 z-10 bg-[#100C2A] text-white "
                                            rowSpan={2}
                                        >
                                            {row.seq}
                                        </td>
                                        <td
                                            className="p-2 border sticky left-[3px] z-10 bg-[#100C2A] text-white "
                                            rowSpan={2}
                                        >
                                            {row.partnumber}
                                        </td>
                                        ...
                                        <td className="p-2 border whitespace-nowrap text-white ">Target </td>
                                        <td className="p-2 border whitespace-nowrap text-white ">
                                            {row.timeslots &&
                                        ...
                                        {row.timeslots &&
                                            Object.entries(row.timeslots).map(([slot, values]) =>
                                                values.target?.map((val, i) => (
                                                    <td
                                                        key={`${slot}-target-${i}`}
                                                        className={`p-1 border whitespace-nowrap text-white ${val === null ? "" : "bg-[#e0e0e0a2]"
                                                            }`}
                                                    >
                                                        <div
                                    ...
                                    <tr>
                                        <td className="p-2 border whitespace-nowrap text-white ">Actual</td>
                                            ...
                                            Object.entries(row.timeslots).map(([slot, values]) =>
                                                values.actual.map((val, i) => {
                                                    ...
                                                    return (
                                                        <td
                                                            key={`${slot}-actual-${i}`}
                                                            className="p-1 border whitespace-nowrap text-white "
