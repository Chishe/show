...
export default function Loss() {
  ...
  const renderModel = () => {
    switch (shiftState) {
      case "☀️":
        return <TimeSlotChart nametableurl="core_5" dateTime={dateTime} />;
      case "🌙":
        return <TimeSlotChart2 nametableurl="core_5" dateTime={dateTime} />;
      case "All":
        return <TimeSlotChart3 nametableurl="core_5" dateTime={dateTime} />;
      default:
        return null;
    }
  };
  const renderModel1 = () => {
    switch (shiftState) {
      case "☀️":
        return <Modal nametableurl="core_5" dateTime={dateTime} />;
      case "🌙":
        return <Modal2 nametableurl="core_5" dateTime={dateTime} />;
      case "All":
        return <Modal3 nametableurl="core_5" dateTime={dateTime} />;
      default:
        return null;
    }
  };
