...
export default function Loss() {
  ...
  const renderModel = () => {
    switch (shiftState) {
      case "☀️":
        return <TimeSlotChart nametableurl="core_4" dateTime={dateTime} />;
      case "🌙":
        return <TimeSlotChart2 nametableurl="core_4" dateTime={dateTime} />;
      case "All":
        return <TimeSlotChart3 nametableurl="core_4" dateTime={dateTime} />;
      default:
        return null;
    }
  };
  const renderModel1 = () => {
    switch (shiftState) {
      case "☀️":
        return <Modal nametableurl="core_4" dateTime={dateTime} />;
      case "🌙":
        return <Modal2 nametableurl="core_4" dateTime={dateTime} />;
      case "All":
        return <Modal3 nametableurl="core_4" dateTime={dateTime} />;
      default:
        return null;
    }
  };
  const renderModel2 = () => {
    switch (shiftState) {
      case "☀️":
        return <PlanTable nametableurl="core_4" dateTime={dateTime} />;
      case "🌙":
        return <PlanTable2 nametableurl="core_4" dateTime={dateTime} />;
      case "All":
        return <PlanTable3 nametableurl="core_4" dateTime={dateTime} />;
      default:
        return null;
    }
  };
    ...
    <div className="h-full flex justify-center p-4">
      ...
      >
        ...
        <div>
          ...
          <LossMemo nametableurl="core_4" dateTime={dateTime} />
        </div>
      </div>
    </div>
  );
