...
export default function Loss() {
  ...
  const renderModel2 = () => {
    switch (shiftState) {
      case "☀️":
        return <PlanTable nametableurl="core_3" dateTime={dateTime} />;
      case "🌙":
        return <PlanTable2 nametableurl="core_3" dateTime={dateTime} />;
      case "All":
        return <PlanTable3 nametableurl="core_3" dateTime={dateTime} />;
      default:
        return null;
    }
  };
    ...
    <div className="h-full flex justify-center p-4">
      ...
      >
        ...
        <div>
          ...
          <LossMemo nametableurl="core_3" dateTime={dateTime} />
        </div>
      </div>
    </div>
  );
